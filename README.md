...
```
<br> Também há outros métodos, como:
**findOne:** usado para recuperar um único registro que corresponde a uma determinada condição de pesquisa;
**findFirst:** recupera o primeiro registro que corresponde a uma determinada condição de pesquisa;
