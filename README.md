...
```
Também há outros métodos, como:<ul>
<li>**findOne:** usado para recuperar um único registro que corresponde a uma determinada condição de pesquisa;</li>l
<li>**findFirst:** recupera o primeiro registro que corresponde a uma determinada condição de pesquisa;</li>
<li>**upsert:** combina o "create" e o "update" em uma única chamada de método. Ele verifica se um registro já existe com base em uma condição de pesquisa e, se existir, realiza uma atualização; caso contrário, cria um novo registro.</li></ul>
